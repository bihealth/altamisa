...
def test_minimal_model_creation(tmp_path):
    ...
    with open(tmp_path / investigation.info.path, "wt", newline="") as outputf:
    ...
    with open(tmp_path / investigation.studies[0].info.path, "wt", newline="") as outputf:
    ...
    with open(tmp_path / investigation.studies[0].assays[0].path, "wt", newline="") as outputf:
